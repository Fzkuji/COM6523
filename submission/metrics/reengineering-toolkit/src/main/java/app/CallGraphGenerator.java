...
public class CallGraphGenerator {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Signature mostUsesMethod = findMostUsesMethod(cg);
        System.out.println(cg);
        System.out.println("The most called method is: "+mostUsedMethod);
        System.out.println("The most caller method is: "+mostUsesMethod);
    }
    ...
    private static Signature findMostUsesMethod(CallGraph cg) throws IOException {
        int max = 0;
        Signature maxSignature = null;
        String toReturn = "Method, Number of uses\n";
        for(Signature sig : cg.getCallGraph().getNodes()){
            ...
            BufferedWriter fw = new BufferedWriter(new FileWriter("most_uses_methods.csv"));
            fw.write(toReturn);
            fw.flush();
            fw.close();
            if(outgoing >max){
